...
namespace IIS.Test2
{
    ...
    public class Contact : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Test2.ContactType fContactType;
        
        private IIS.Test2.DetailArrayOfPhone fPhone;
        ...
        [NotNull()]
        public virtual IIS.Test2.ContactType ContactType
        {
            get
            {
                ...
                IIS.Test2.ContactType result = this.fContactType;
        ...
        public virtual IIS.Test2.DetailArrayOfPhone Phone
        {
            get
            {
                ...
                if ((this.fPhone == null))
                {
                    this.fPhone = new IIS.Test2.DetailArrayOfPhone(this);
                }
                IIS.Test2.DetailArrayOfPhone result = this.fPhone;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ContactE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ContactE", typeof(IIS.Test2.Contact));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ContactL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ContactL", typeof(IIS.Test2.Contact));
                }
            }
        }
    }
